import{_ as n,o as s,c as a,a as t}from"./app.a768e67e.js";const p={},o=t(`<h1 id="документация-api" tabindex="-1"><a class="header-anchor" href="#документация-api" aria-hidden="true">#</a> Документация API</h1><h2 id="createnervue" tabindex="-1"><a class="header-anchor" href="#createnervue" aria-hidden="true">#</a> createNervue</h2><p>Возвращает <code>vue</code> плагин, который установит <code>root</code> объект Nervue в качестве глобальной переменной, доступ к которой можно получить с помощью инъекции по ключу <code>nervueSymbol</code>.</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createNervue <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;nervue&#39;</span>
