...
<p>Функция, которая в качестве аргумента принимает <code v-pre>id</code> конкретного хранилища, которое зарегистрировано в <code v-pre>root</code>
объекте, с помощью метода <code v-pre>add</code></p>
