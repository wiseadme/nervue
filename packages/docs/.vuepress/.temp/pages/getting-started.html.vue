<template><div><h1 id="начинаем" tabindex="-1"><a class="header-anchor" href="#начинаем" aria-hidden="true">#</a> Начинаем</h1>
...
</code></pre></div><p>Далее после установки библиотеки, вы можете создать глобальный <code v-pre>instance</code> <strong>Nervue</strong></p>
...
</code></pre></div><p>В <code v-pre>main.js</code></p>
...
</code></pre></div><p>Таким образом вы создали <code v-pre>root</code> объект, куда по необходимости вы сможете добавлять локальные хранилища с помощью
...
</code></pre></div><p>Метод <code v-pre>add</code> сохранит по <code v-pre>id</code> ключу ваше хранилище в <code v-pre>root</code> объекте.</p>
<p>Соответственно теперь для того, что бы получить доступ из любой точки вашего приложения к сохраненному хранилищу, вам будет достаточно
