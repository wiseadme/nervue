...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre></div><p>And this basic local example, in principle, will be enough to organize the store of your reactive application. Interesting? Well, then let&#39;s move on.</p><div class="custom-container tip"><p class="custom-container-title">info</p><p>Next, you will learn more about the library&#39;s capabilities.</p></div></div>`);
}
